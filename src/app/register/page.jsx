...
export default function Register() {
    ...
    const {pageLevelLoader, setpageLevelLoader, isAuth} = useContext(GlobalContext)
    ...
    return (
        <div className="max-h-screen-xl">
            <div className="flex flex-col items-center justify-between pt-0 pb-0 mt-20 mr-auto xl:px-5 lg:flex-row">
