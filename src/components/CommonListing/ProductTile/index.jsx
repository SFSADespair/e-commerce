            ...
            <div>
                ...
                </div>
                {
                    item.onSale === 'yes' ? (
                        <div className="absolute top-0 m-2 rounded-full bg-black">
                            <p className="rounded-full p-1 text-[8px] font-bold uppercase tracking-wide text-white sm:py1 sm:px-3">
                                Sale
                            </p>
                        </div>
                    ) : null
                ...
                <div className="my-4 mx-auto flex w-10/12 flex-col items-start justify-between">
                    <div className="mb-2 flex">
                        <p className={`mr-3 text-sm font-semibold ${item.onSale === 'yes' ? 'line-through text-gray-400' : ''}`}>
                            {`$ ${item.price}`}
                        </p>
                        {item.onSale === 'yes' ? (
